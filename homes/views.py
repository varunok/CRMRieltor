...
class ObjectList(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # self.context['images'] = ImagesFacility.objects.filter(album__in=self.object_list)
...
class ArendatorsList(ListView):
    ...
    queryset = Arendator.objects.filter(trash=False).order_by('-add_date')
...
class BuyersList(ListView):
    ...
    queryset = Buyer.objects.filter(trash=False).order_by('-add_date')
