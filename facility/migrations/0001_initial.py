...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('type_loyality', models.CharField(max_length=50, unique=True, null=True, verbose_name='\u0422\u0438\u043f \u043b\u043e\u044f\u043b\u044c\u043d\u043e\u0441\u0442\u0438')),
            ],
            options={
                'verbose_name': '\u0422\u0438\u043f \u043b\u043e\u044f\u043b\u044c\u043d\u043e\u0441\u0442\u0438',
                'verbose_name_plural': '\u0422\u0438\u043f\u044b \u043b\u043e\u044f\u043b\u044c\u043d\u043e\u0441\u0442\u0438',
            },
        ),
        migrations.CreateModel(
            name='TypeOperations',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('review_date', models.DateField(null=True, verbose_name='\u041f\u0435\u0440\u0435\u0441\u043c\u043e\u0442\u0440 \u0414\u0430\u0442\u0430')),
                ('review_time', models.TimeField(auto_now_add=True, verbose_name='\u041f\u0435\u0440\u0435\u0441\u043c\u043e\u0442\u0440 \u0412\u0440\u0435\u043c\u044f', null=True)),
                ('call_date', models.DateField(null=True, verbose_name='\u0417\u0432\u043e\u043d\u043e\u043a \u0414\u0430\u0442\u0430')),
                ...
                ('phone_owner', models.CharField(max_length=16, null=True, verbose_name='\u0422\u0435\u043b\u0435\u0444\u043e\u043d', blank=True)),
                ('phone_owner_plus', models.CharField(max_length=16, null=True, verbose_name='\u0414\u043e\u043f\u043e\u043b. \u0422\u0435\u043b\u0435\u0444\u043e\u043d', blank=True)),
                ('contact_owner', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, verbose_name='\u0422\u0438\u043f \u043a\u043e\u043d\u0442\u0430\u043a\u0442\u0430 \u0432\u043b\u0430\u0434\u0435\u043b\u044c\u0446\u0430', to='facility.TypeContactOwner')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='actuality',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, verbose_name='\u0410\u043a\u0442\u0443\u0430\u043b\u044c\u043d\u043e\u0441\u0442\u044c', to='facility.TypeActuality'),
        ),
        migrations.AddField(
            model_name='addressfacilitydata',
            name='condition',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, verbose_name='\u0421\u043e\u0441\u0442\u043e\u044f\u043d\u0438\u0435', to='facility.TypeCondition'),
        ),
        migrations.AddField(
            model_name='addressfacilitydata',
            name='district_obj',
        ...
        migrations.AddField(
            model_name='addressfacilitydata',
            name='loyality',
            field=models.ManyToManyField(to='facility.TypeLoyality', verbose_name='\u041b\u043e\u044f\u043b\u044c\u043d\u043e\u0441\u0442\u044c'),
        ),
        migrations.AddField(
            model_name='addressfacilitydata',
            name='repairs',
